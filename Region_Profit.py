...
def Regional_Insight():
    ...
    while not Regional_Data_Input or not Regional_Data_Input.isdigit() or Regional_Data_Input.isdigit():
        if not Regional_Data_Input:
            Regional_Data_Input = input("Response cannot be blank. Please enter a number from 1-3 to see the regional data:  \n \n [1] Identify Product Sales By Region Each Year \n [2] Identify Total Sales and Total Profit By Region  \n [3] Go Back To Main Menu  \n \n Please enter here: ")
            continue
       
        if not Regional_Data_Input.isdigit():
            Regional_Data_Input= input("Response must contain numbers only. Please enter a number from 1-3 to see the regional data: \n \n [1] Identify Product Sales By Region Each Year \n [2] Identify Total Sales and Total Profit By Region  \n [3] Go Back To Main Menu \n \n Please enter here: ")
            continue
       
        if Regional_Data_Input.isdigit():
            Regional_Input_Int = int (Regional_Data_Input)
            if Regional_Input_Int == 0 or Regional_Input_Int > 3:
                Regional_Data_Input = input("Incorrect number. Please enter a number from 1-3 to see the regional data: \n \n [1] Identify Product Sales By Region Each Year \n [2] Identify Total Sales and Total Profit By Region  \n [3] Go Back To Main Menu \n \n Please enter here: ")
                continue
                ...
                while not Regional_Year or not Regional_Year.isdigit() or Regional_Year.isdigit():
                        ...
                        if Regional_Year.isdigit():
                            ...
                            if Regional_Year_Input == 1:
                                ...
                                region_profit_subCat = year_sales [["Region", "Profit", "Sub-Category"]]
                     ...
                     #for each value in regions:
                                for region in regions:
                                 ...
                                 plt.show()
                            break
                Regional_Data_Input = input("Insight Completed. Would you like to see another data set?: \n \n [1] Identify Product Sales By Region Each Year \n [2] Identify Total Sales and Total Profit By Region  \n [3] Go Back To Main Menu \n \n Please enter here: ")

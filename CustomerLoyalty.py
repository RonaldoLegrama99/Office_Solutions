...
#Populates Customer Loyalty Program Menu 
#Allows users to enter input to see desired data insight
def CustomerLoyaltyMenu():
    
    print("\n----------------------------------")
    print("Customer Data For Loyalty Program")
    print("----------------------------------")
    ...
    while not customer_loyalty or not customer_loyalty.isdigit() or customer_loyalty.isdigit():
        ...
        if not customer_loyalty.isdigit():
            customer_loyalty = input("Response must contain numbers only. Please re-enter a number from 1-4 to look at the data insights for customer loyalty program: \n \n [1] Customer Segment Purchase Frequency \n [2] Top 10 Customers By Segment With/Without Discount \n [3] Bottom 10 Customers By Segment With/Without Discount \n [4] Go Back To Main Menu \n \n Please enter here: ")
            continue
        if customer_loyalty.isdigit():
            Enter_Int = int(customer_loyalty)
            if Enter_Int == 0 or Enter_Int > 4:
                customer_loyalty = input("Incorrect number entered. Please re-enter a number from 1-5: \n \n [1] Customer Segment Purchase Frequency \n [2] Top 10 Customers By Segment With/Without Discount \n [3] Bottom 10 Customers By Segment With/Without Discount \n [4] Go Back To Main Menu  \n \n Please enter here: " )
                continue
            ...
            customer_loyalty = input("Insight Completed. Would you like to see another data set: \n \n [1] Customer Segment Purchase Frequency \n [2] Top 10 Customers By Segment With/Without Discount \n [3] Bottom 10 Customers By Segment With/Without Discount \n [4] Go Back To Main Menu  \n \n Please enter here: ")
